...
mv -n src/main/java/com/sbvadmin/generator/tempFiles/com/${1%.*}/vue/i18nEN/* ../../../${2%.*}/src/locales/lang/en/routes
mv -n src/main/java/com/sbvadmin/generator/tempFiles/com/${1%.*}/vue/i18nZH/* ../../../${2%.*}/src/locales/lang/zh-CN/routes
